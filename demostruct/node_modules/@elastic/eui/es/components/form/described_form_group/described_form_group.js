...
export var EuiDescribedFormGroup = function EuiDescribedFormGroup(_ref) {
  ...
  return React.createElement(EuiInnerText, null, function (ref, innerText) {
    return React.createElement("fieldset", _extends({
      className: classes
    }, rest), React.createElement(EuiScreenReaderOnly, null, React.createElement("legend", null, innerText)), React.createElement(EuiFlexGroup, {
      gutterSize: gutterSize
    }, React.createElement(EuiFlexItem, null, React.createElement("span", {
      ref: ref
