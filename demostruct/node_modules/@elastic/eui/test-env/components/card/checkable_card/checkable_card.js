...
var EuiCheckableCard = function EuiCheckableCard(_ref) {
  ...
  if (checkableType === 'radio') {
    checkableElement = _react.default.createElement(_radio.EuiRadio, (0, _extends2.default)({
      checked: checked,
      disabled: disabled
    }, rest));
  } else {
    checkableElement = _react.default.createElement(_checkbox.EuiCheckbox, (0, _extends2.default)({
      checked: checked,
      disabled: disabled
    }, rest));
  }
