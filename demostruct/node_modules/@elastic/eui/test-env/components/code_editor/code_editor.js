...
function (_Component) {
  ...
  function EuiCodeEditor() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EuiCodeEditor)).call.apply(_getPrototypeOf2, [this].concat(_args)));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onKeydownAce", function (ev) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onFocusAce", function () {
      _this.setState({
        isEditing: true
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onBlurAce", function () {
      _this.stopEditing();
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onKeyDownHint", function (ev) {
  ...
  (0, _createClass2.default)(EuiCodeEditor, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props3, ["width", "height", "onBlur", "isReadOnly", "setOptions", "cursorStart", "mode", "data-test-subj"]);
