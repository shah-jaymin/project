...
function (_Component) {
  ...
  function EuiComboBox(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(EuiComboBox).call(this, props));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateListPosition", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onComboBoxFocus", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "comboBoxRef", function (node) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "autoSizeInputRef", function (node) {
      _this.autoSizeInput = node;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "searchInputRef", function (node) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "optionsListRef", function (node) {
      _this.optionsList = node;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "optionRef", function (index, node) {
      _this.options[index] = node;
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "toggleButtonRef", function (node) {
  ...
  (0, _createClass2.default)(EuiComboBox, [{
    ...
    value: function render() {
      ...
      var _this$props8 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props8, ["id", "isDisabled", "className", "isLoading", "options", "selectedOptions", "onCreateOption", "placeholder", "noSuggestions", "renderOption", "singleSelection", "onChange", "onSearchChange", "async", "onBlur", "inputRef", "isInvalid", "rowHeight", "isClearable", "fullWidth", "compressed", "data-test-subj"]);
...
(0, _defineProperty2.default)(EuiComboBox, "propTypes", {
