...
function (_Component) {
  ...
  function EuiCodeEditor() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeydownAce", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onFocusAce", function () {
      _this.setState({
        isEditing: true
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "onBlurAce", function () {
      _this.stopEditing();
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyDownHint", function (ev) {
